...
// Default constructor
ZB_MonitoringAndControl::ZB_MonitoringAndControl(): Thread()
{
    run_ = false;
}
...
// Constructor
ZB_MonitoringAndControl::ZB_MonitoringAndControl(string device): Thread(), device_(device)
{
    run_ = false;
}
...
void ZB_MonitoringAndControl::accessMessagePool(string& message)
{
    lock(); // acquire lock
    {
